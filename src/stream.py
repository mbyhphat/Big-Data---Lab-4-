...
parser = argparse.ArgumentParser(description='Streams Breast Cancer Data to Spark Streaming Context')
parser.add_argument('--file-path', '-f', help='File Path', required=True, type=str)
